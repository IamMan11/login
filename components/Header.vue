<template> 
    <div class="bg-orange-200 flex justify-between align-middle p-4">
        <div class="flex">
            <h1 class="pr-4 flex items-center">
                <a href="index" class="text-white"> perdee coffee </a>
            </h1>
        ...
        <div class="flex items-center">
            <ul class="list-none m-0 p-0 gap-4">
                ...
                <li class="inline mr-4"><a id="login" href="logpage" class=" decoration-gray-50">Log In</a></li>
            </ul>
        </div>
    </div>
</template>
